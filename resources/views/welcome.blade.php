...
<body class="bg-[#080E1C]">
    ...
    <header class="bg-[#231D4C] relative overflow-hidden max-w-[1920px] mb-24 mx-auto">
        <!-- navbar area -->
        ...
        <section
            ...
            <div class=" container mx-auto px-3 lg:px-5">
                <div class="page relative z-20 mb-8">
                    <h1 class="uppercase text-7xl text-white font-bold">
                        Launch Your
                        <span class="block">
                            <span class="text-[#6564ED]">AdonisJS</span> Skills
                        </span>
                        <span class="block">to the Stars</span>
                    </h1>
                </div>

                <div class="gap-5">
                    <button class="bg-white px-12 py-2 rounded-md text-black">Sign up for free</button>
                    <button
                        class="bg-transparent border border-white px-12 py-2 rounded-md text-white hover:cursor-pointer hover:bg-white hover:text-black transition duration-500 ease-out items-center font-semibold">New
                        to AdonisJS? start here <i class="fa-solid fa-arrow-right"></i></button>
                </div>
            </div>
            <div class="absolute z-20 bottom-0 left-0 w-full pointer-events-none"><svg class="text-body -mb-3"
                    ...
                    <g id="OBJECTS">
                        <path
                            ...
                            style="fill:none;fill-rule:nonzero;stroke:#080E1C;stroke-width:4.17px;"></path>
                        <path
                            ...
                            style="fill:none;fill-rule:nonzero;stroke:currentColor;stroke-width:4.17px;"></path>
                        <path
                            ...
                            style="fill:currentColor;fill-rule:nonzero;stroke:currentColor;stroke-width:4.17px;"></path>
                        <path
            ...
            <div class="absolute w-full aspect-video top-0 left-0 overflow-hidden">
                <video class="w-full opacity-[70%] hue-rotate-[75deg] mix-blend-exclusion" muted="" autoplay=""
                    loop="" playsinline="">
                    <source src="{{ asset('images/aurora-bg-loop.mp4') }}" type="video/mp4"
                        media="all and (min-width: 1501px)">
                    <source src="{{ asset('images/aurora-bg-loop-1920.mp4') }}" type="video/mp4"
                        media="all and (max-width: 1500px)">
                    <source src="{{ asset('images/aurora-bg-450.mp4') }}" type="video/mp4"
                        media="all and (max-width: 450px)">
                </video>
                <div
                    class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-slate-base-950/0 via-slate-base-950/0 to-brand-base-950 z-10">
                </div>
            </div>
        </section>
    </header>
    ...
    <main class="container mx-auto px-3 lg:px-5 py-10">
        <h1 class="text-black text-4xl font-bold">Series.</h1>
        <div class="lg:flex items-center justify-between">
            <h3 class="text-[#4F46E5] text-xl font-semibold">Step-By-Step Learning</h3>
            <h3 class="text-[#020617] text-xl font-semibold items-center">Browse All Series <i
                    class="fa-solid fa-arrow-right"></i></h3>
        </div>

        <div class="md:flex items-stretch justify-between gap-8 gap-x-8">
            <div
                class="bg-[#0F172A] flex gap-5 p-5 rounded-md lg:basis-2/3 hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <div class="lg:basis-1/2">
                    <h1 class="text-[#fff] text-lg font-bold">Adding an API to an AdonisJS Web App</h1>
                    ...
                    <p class="text-[#94a3b8] text-sm lg:text-base">In this series, we'll ad a API, using Opaque Access
                        Tokens for
                ...
                <div class="lg:basis-1/2 py-2 hidden lg:block">
            ...
            <div
                class="bg-[#0F172A] lg:basis-1/3 p-5 my-5 lg:my-0 rounded-md lg:min-h-[300px] hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <h4 class="text-[#fff] text-lg font-bold">AdonisJS Quick tip</h4>
                ...
                <p class="text-[#94a3b8] text-sm lg:text-base">Quick tips, lessons, and screencasts covering specific
                    topics on AdonisJS.
                </p>
            </div>
        </div>

        <div class="md:flex items-stretch justify-between gap-5 lg:py-5">
            <div
                class="bg-[#0F172A] lg:basis-1/3 p-5 rounded-md lg:min-h-[300px] hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <h4 class="text-[#fff] text-lg font-bold">Building with AdonisJS & Inertia</h4>
                <div class="flex items-center gap-5 text-[12px] text-[#94a3b8] mb-1">
                    <h3><i class="fa-solid fa-graduation-cap"></i> 91 Lessons</h3>
                    <h3><i class="fa-solid fa-clock"></i> 14h 5m</h3>
                </div>
                <p class="text-[#94a3b8] text-sm lg:text-base">We well how to use InertiaJs with AdonisJS 6 to build a
                    feature-complete
            ...
            <div
                class="bg-[#0F172A] flex gap-3 p-5 my-5 lg:my-0 rounded-md lg:basis-2/3 hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <div class="lg:basis-1/2">
                    <h1 class="text-[#fff] text-lg font-bold">AdonisJS in 30</h1>
                    <div class="flex items-center gap-10 my-1 text-[#94a3b8] text-sm">
                        <h3><i class="fa-solid fa-graduation-cap"></i> 9 Lessons</h3>
                        <h3><i class="fa-solid fa-clock"></i> 2h 59m</h3>
                    </div>
                    <p class="text-[#94a3b8] text-sm lg:text-base">In this series, we'll highlight various features and
                ...
                <div class="lg:basis-1/2 py-2 hidden lg:block">
                    ...
                    <h4 class="capitalize font-bold text-[#fff] text-sm mb-3">How To Add Social Authentication
                        with
                    ...
                    <h4 class="capitalize font-bold text-[#fff] text-sm mb-3">How to make a simple AdonisJS 6 Package
                    </h4>
                    <div class="flex items-center gap-5 my-1 text-[#94a3b8] text-sm">
                        <h4>Lesson 7.0</h4>
                        <span>.</span>
                    ...
                    <h4 class="capitalize font-bold text-[#fff] text-sm mb-3">Three Approaches for organizing your
                        AdonisJS Business Logic Operations.</h4>
                </div>
            </div>
        </div>

        <div class="md:flex items-stretch justify-between gap-3 py-5">
            <div
                class="bg-[#0F172A] flex gap-3 p-5 rounded-md lg:basis-2/3 hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <div class="lg:basis-1/2">
                    <h1 class="text-[#fff] text-lg font-bold">Let's Learn AdonisJS 6</h1>
                    <div class="flex items-center gap-5 text-[12px] text-[#94a3b8] mb-1">
                        <h3><i class="fa-solid fa-graduation-cap"></i> 113 Lessons</h3>
                        <h3><i class="fa-solid fa-clock"></i> 14h 11m</h3>
                    </div>
                    <p class="text-[#94a3b8] text-sm lg:text-base">In this series, we'll learn AdonisJS 6 Step-By-Step
                        in a
                ...
                <div class="lg:basis-1/2 py-2 hidden lg:block">
                    ...
                    <h4 class="uppercase font-bold mb-5 text-[#0F172A] text-xs">Thank you for watching!</h4>
                    <div class="flex items-center gap-5">
                        <h4>Lesson 11.10</h4>
                        <span>.</span>
                        <h4>Jun 29, 24</h4>
                    </div>
                    <h4 class="uppercase font-bold mb-5 text-[#0F172A] text-xs">Allowing Admins to delete Movies and
                    ...
                    <h4 class="uppercase font-bold mb-5 text-[#0F172A] text-xs">Managed Transactions and Syncing Movie
                        cast Members.</h4>
                </div>
            </div>
            <div
                class="bg-[#0F172A] lg:basis-1/3 p-5 my-5 lg:my-0 rounded-md lg:min-h-[300px] hover:cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                <h4 class="text-[#fff] text-lg font-bold">EdgeJS components</h4>
                <div class="flex items-center gap-5 my-1 text-[#94a3b8] text-sm">
                    <h3><i class="fa-solid fa-graduation-cap"></i> 25 Lessons</h3>
                    <h3><i class="fa-solid fa-clock"></i> 1h 42m</h3>
                </div>
                <p class="text-[#94a3b8] text-sm lg:text-base">In this series, we'll take a deep dive into EdgeJS
    ...
    <section id="topics_area">
        <div class="container mx-auto px-3 lg:px-5 py-10">
            <h1 class="text-black text-4xl font-bold">Topics.</h1>
            <div class="lg:flex items-center justify-between">
                <h3 class="text-[#4F46E5] text-xl font-semibold uppercase">Subject Based Learning</h3>
                <h3 class="text-[#020617] text-xl font-semibold items-center">Browse All Topics <i
                        class="fa-solid fa-arrow-right"></i></h3>
            </div>

            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/terminal_1697770046459.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Ace CLI</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 15 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/adonisjs-icon-with-bg_1671308746819.jpeg') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">AdonisJS</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 15 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 394 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/alpinejs_1706922995887.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">AlpineJS</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 2 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 7 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/authentication_1697770401414.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Authentication</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 9 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 43 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/authorization_1697770201941.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Authentication</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 14 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/aws-amplify-logo-D68DDB5AB1-seeklogo_1671308415523.png') }}"
                            alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">AWS Amplify</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 8 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/bouncer_1697770362618.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Bouncer</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 4 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                <div
                    class="bg-[#0F172A] rounded-md p-2 flex items-center gap-1 group cursor-pointer border-2 border-transparent hover:border-[#1e293b]">
                    <div class="pr-3 flex items-center">
                        <img src="{{ asset('images/abstract_1697804733488.png') }}" alt="aci"
                            class="w-16 h-auto object-contain rounded-md transition-transform duration-300 ease-in-out group-hover:scale-110" />
                    </div>
                    <div>
                        <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Ace CLI</h3>
                        <div class="flex items-center gap-5 mb-3 text-[#94a3b8] text-xs">
                            <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                            <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 35 Lessons</h3>
                        </div>
                    </div>
                </div>
                ...
                {{-- <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/sound-mixer_3591072_1707160896041.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">controllers</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 7 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 34 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/debugging_1706358516416.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Ace CLI</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 0 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 3 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/drive_1697804954408.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Ace CLI</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 1 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/edgejs_1699649088846.jpeg') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">EdgeJS</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 8 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 90 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/email_1697804518607.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Email</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 2 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 6 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/htmx_1697801632070.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">HTMX</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 5 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/context_1697770135031.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">HTTPContext</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 6 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 26 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/inertia-icon_1654439516110.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">InertiaJs</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 2 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 102 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/kisspng-javascript-computer-icons-scalable-vector-graphics-list-of-javascript-enhancements-fandom-developers-5d145895da3992_1671308232289.png') }}"
                                alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Javascript</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 11 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/lucid_1697770485756.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Lucid</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 10 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 148 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/markdown_1706324528558.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Markdown</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 3 Lessons</h3>
                            </div>
                ...
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/nuxt_1649707654083.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Nuxt</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 7 Lessons</h3>
                            </div>
                ...
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/redis-cube-red_white-rgb_1706358822819.png') }}"
                                alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Redis</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 2 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/router_1697770100982.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Router</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 6 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 49 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/settings_802226_1706324200876.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Settings</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 5 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 18 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/tailwindcss_1706923172274.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Tailwind</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 4 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 22 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/tips_1697770326569.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Tips</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 24 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/ts-logo-512_1706359000829.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Typescript</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 10 Lessons</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/validator_1697770242096.png') }}" alt="aci"
                                class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Validator</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 5 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 35 Lessons</h3>
                            </div>
                ...
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/vite_1706323617873.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">Vite</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 1 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 3 Lessons</h3>
                            </div>
                ...
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/vscode_1706359259635.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">VSCode</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 0 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 3 Lessons</h3>
                            </div>
                ...
                <div class="bg-[#0F172A] rounded-md">
                    <div class="p-2 flex items-center gap-1">
                        <div>
                            <img src="{{ asset('images/vue_1665253470537.png') }}" alt="aci" class="w-24">
                        </div>
                        <div class="">
                            <h3 class="text-[#E2E8F0] font-bold text-sm xl:text-base mb-1">VueJS</h3>
                            <div class="flex items-center gap-5 mb-3 text-[#475569]">
                                <h3 class="text-xs"><i class="fa-solid fa-server"></i> 3 series</h3>
                                <h3 class="text-xs"><i class="fa-solid fa-graduation-cap"></i> 90 Lessons</h3>
                            </div>
    ...
    <section class="lesson_area">
        <div class="container mx-auto px-3 lg:px-5 py-10">
            ...
            <div class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 py-3">
                ...
                <div class="group">
                    <div class="rounded-lg">
                        <img src="{{ asset('images/prsaa7xekw3w4bkda4t9af9d.jpg') }}" alt="advanced"
                            class="rounded-lg">
                    </div>
                    <div class="flex items-center justify-between gap-3 py-1 text-[#818cf8] text-xs">
                        <p>Adding an Api to...</p>
    ...
    <section class="">
        <div class="container mx-auto px-3 lg:px-5 py-10">
            <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-10">
                <div>
                    <div>
                        <h1 class="text-2xl md:text-3xl xl:text-4xl font-heading font-black tracking-tight text-white">
                            Blogs.</h1>
                        <div class="lg:flex items-center justify-between">
                            <h3 class="text-base font-bold text-brand-600 uppercase text-[#818cf8] mt-1">odds and ins
                            </h3>
                            <h3 class="sm:flex sm:justify-end sm:items-end flex-col text-[#ffff]">Browse All Blogs <i
                                    class="fa-solid fa-arrow-right"></i></h3>
                        </div>
                    </div>
                    <div>
                        <div class="py-2 text-[#475569]">
                            <h4 class="flex items-center gap-x-4 text-xs text-[#94a3b8]">Dec 30, 24</h4>
                            <h1
                                class="mt-2 text-lg font-semibold leading-6 relative elative
                            ...
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">We'll discuss a new ongoing
                                test will be running with
                                our
                                video storage & delivery</p>
                        </div>
                        <div class="py-2 text-[#475569]">
                            <h4 class="flex items-center gap-x-4 text-xs text-[#94a3b8]">Feb 03, 24</h4>
                            <h1
                                class="mt-2 text-lg font-semibold leading-6 relative elative
                                after:content-[''] after:absolute after:left-0 after:bottom-0
                                after:w-0 after:h-[2px] after:bg-[#ffff]
                            ...
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">we're now rocking AdonisJS 6
                                with a fresh redesign to
                                boot! We'll introduce "The Feed" and discuss a few new Adocasts plus perks.</p>
                        </div>
                        <div class="py-2 text-[#475569]">
                            <div class="text-xs flex items-center gap-10 text-[#94a3b8]">
                                <h4 class="flex items-center gap-x-4 text-xs">Jan 25, 24</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#adonisjs</h4>
                            </div>
                            <h1
                                class="mt-2 text-lg font-semibold leading-6 relative elative
                                after:content-[''] after:absolute after:left-0 after:bottom-0
                            ...
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">AdonisJS has officially been
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl xl:text-4xl font-heading font-black tracking-tight text-white">
                        Snippets.</h1>
                    <div class="lg:flex items-center justify-between">
                        <h3 class="text-base font-bold text-brand-600 uppercase text-[#818cf8] mt-1">Bite Sized code
                        </h3>
                        <h3 class="sm:flex sm:justify-end sm:items-end flex-col text-[#ffff]">Browse All Snippets <i
                                class="fa-solid fa-arrow-right"></i></h3>
                    </div>
                    <div>
                        <div class="py-2 text-[#475569]">
                            <div class="text-xs flex items-center gap-10 mb-1 text-[#94a3b8]">
                                <h4>Sep 15, 24</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#adonisjs</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#lucid</h4>
                            </div>
                            <h1
                                class="mt-2 text-lg font-semibold leading-6 relative elative
                                after:content-[''] after:absolute after:left-0 after:bottom-0
                            ...
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">Ever need to directly access
                                knexJS, the query
                                builder
                        ...
                        <div class="py-2 text-[#475569]">
                            <div class="text-xs flex items-center gap-10 mb-1 text-[#94a3b8]">
                                <h4 class="flex items-center gap-x-4 text-xs">Feb 10, 24</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#tailwind</h4>
                            </div>
                            <h1
                                class="mt-2 text-lg font-semibold leading-6 relative elative
                                after:content-[''] after:absolute after:left-0 after:bottom-0
                                ...
                                Tap
                                Devices</h1>
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">Did you know you can quick
                                and easily disable
                                Tailwind's
                        ...
                        <div class="py-2 text-[#475569]">
                            <div class="text-xs flex items-center gap-10 mb-1 text-[#94a3b8]">
                                <h4>Feb 04, 24</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#components</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#tailwind</h4>
                                <h4 class="flex items-center gap-x-4 text-xs">#adonisjs</h4>
                            </div>
                            <h1
                            ...
                            <p class="mt-2 line-clamp-3 text-sm leading-6 text-[#94a3b8]">With AdonisJS 6, has been
                                removed in favor of
                                components.
